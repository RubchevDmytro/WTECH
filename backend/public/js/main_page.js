document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadProducts(page) {
        ...
        // Реализуйте AJAX-запрос или другую логику загрузки
    }
    ...
    if (minInput && maxInput && slider && minThumb && maxThumb && rangeTrack && sliderContainer) {
        ...
        function parsePrice(value) {
            ...
            return isNaN(parsed) ? (value === minInput.value ? minLimit : adjustedMaxLimit) : parsed;
        }
